    ...
    <div class="col-sm-3 col-md-3 pull-right">
        ...
        <% String userlayout = "";
            if(session.getAttribute("userid") == null) {
            	userlayout = "<li><a href='#'><span class='glyphicon glyphicon-user'></span> Sign Up</a></li><li><a href='LoginBuffer'><span class='glyphicon glyphicon-log-in'></span> Login</a></li>";
            }else{
...
<div class="container">
  <h3>Welcome to Khalid's Web Auction!</h3>
  <p>Browse many auctions based on it's category and searched criteria. Remember, you must be logged in to start your own auction and to bid.</p>
</div>
