...
<div class="container">
  <h2>My Auctions</h2>
  <p>Below are your auctions that are currently live.</p>            
  <table class="table table-hover">
    ...
    <tbody>
       ...
       <td><form action="RemoveAuction" method="post"> <input type="hidden" type="text" name="id" value=<% out.print(a.getItemid()); %> /> <input type="submit" value="Remove"></form></td>
       </tr>
       </tbody>
       <!-- close the loop -->
   <% } %>
