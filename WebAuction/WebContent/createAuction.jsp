...
<div class="container">
  ...
  <p>Fill out the form and click start to begin the auction.</p>
  ...
  <div class="form-group" >
   ...
   <div class="form-group">
    ...
    <% Category[] auc = (Category[]) request.getAttribute("category"); for (int i = 0; i < auc.length; i++) {  Category a = auc[i]; %>
			<option  value="<%=a.getCatid()%>"> <% out.print(a.getCatName()); %></option>
			<% } %>
    
    </select>
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Start Price</label>
    <input type="text" class="form-control" name="startprice" placeholder="Start Price">
  </div>
  <button class="btn btn-lg btn-primary btn-block" type="submit">Start Auction</button>
